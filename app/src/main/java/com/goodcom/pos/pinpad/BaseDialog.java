...
public abstract class BaseDialog extends Dialog {
     ...
     * @Description:TODO
     */
    public BaseDialog(Activity context, int layoutResID, int gravity) {
...
//        }
     ...
     * @Description:TODO
     */
    public BaseDialog(Activity context, int layoutResID, int gravity, boolean fullscreen) {
        super(context, R.style.DialogStyle);
        iContext = context;
        setContentView(layoutResID);
        WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
        ...
        if (fullscreen) {
            ...
            lp.height = windowH * 4 / 7;
            if(Build.MODEL.contains("P600")){
                lp.height = windowH * 6 / 7;
            }
        }
        /*
         * lp.x与lp.y表示相对于原始位置的偏移.
...
//        }
     ...
     * @Description:TODO
     */
    public BaseDialog(Activity context, int layoutResID, int x, int y, int gravity) {
        super(context, R.style.DialogStyle);
        iContext = context;
        setContentView(layoutResID);
        WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
