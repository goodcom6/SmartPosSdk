...
public class EmvConfigNew {
    ...
    public static void loadAid() throws RemoteException {
        ...
        aid.TerminalCountryCode = "0156".getBytes();
        aid.MerchantCategoryCode = "0156".getBytes();
        aid.TransCurrencyCode = "0156".getBytes();
        ...
        aid.qualifiers =  PosUtils.hexStringToBytes("DF81180160DF81190108DF811E0160DF812C0108DF811B01B0");
        ...
        aid.qualifiers = PosUtils.hexStringToBytes("E0000000");
        ...
        aid.qualifiers = PosUtils.hexStringToBytes("2600D04B7900");
    ...
    public static void loadAid1() throws RemoteException {
        ...
        aid.TerminalCountryCode = "0840".getBytes();
        aid.MerchantCategoryCode = "0840".getBytes();
        aid.TransCurrencyCode = "0840".getBytes();
        aid.TransCurrencyExp = "02".getBytes();
        GcSmartPosUtils.getInstance().EmvSetAid(MainApp.getInstance().getApplicationContext(), aid);
        ...
        aid.TACOnline = PosUtils.hexStringToBytes("f850acf800");
        aid.TACDefault = PosUtils.hexStringToBytes("fc50aca000");
        aid.qualifiers =  PosUtils.hexStringToBytes("DF81180100DF81190100DF811E0100DF812C0100DF811B01B0");
        ...
        aid.qualifiers = PosUtils.hexStringToBytes("000000000000");
    ...
    public static void loadAid2() throws RemoteException {
        ...
        aid.TACOnline = PosUtils.hexStringToBytes("f850acf800");
        aid.TACDefault = PosUtils.hexStringToBytes("fc50aca000");
        aid.qualifiers = PosUtils.hexStringToBytes("DF811801FFDF811901FFDF811E01FFDF812C01FFDF811B01B0");
        ...
        aid.qualifiers = PosUtils.hexStringToBytes("FFFFFFFFFFFF");
    ...
    private static PosEmvAid addAid(String aid, String version) {
        ...
        appList.TerminalCountryCode = "0156".getBytes();
        appList.MerchantCategoryCode = "0156".getBytes();
        appList.TransCurrencyCode = "0156".getBytes();
